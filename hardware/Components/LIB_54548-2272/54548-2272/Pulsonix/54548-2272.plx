...
//17191305/1494326/2.50/24/3/Connector
...
(library Library_1
	...
	(patternDef "545482272" (originalName "545482272")
		(multiLayer
			(pad (padNum 1) (padStyleRef r100_30) (pt -5.250, 2.400) (rotation 0))
			(pad (padNum 2) (padStyleRef r100_30) (pt -4.750, 2.400) (rotation 0))
			(pad (padNum 3) (padStyleRef r100_30) (pt -4.250, 2.400) (rotation 0))
			(pad (padNum 4) (padStyleRef r100_30) (pt -3.750, 2.400) (rotation 0))
			(pad (padNum 5) (padStyleRef r100_30) (pt -3.250, 2.400) (rotation 0))
			(pad (padNum 6) (padStyleRef r100_30) (pt -2.750, 2.400) (rotation 0))
			(pad (padNum 7) (padStyleRef r100_30) (pt -2.250, 2.400) (rotation 0))
			(pad (padNum 8) (padStyleRef r100_30) (pt -1.750, 2.400) (rotation 0))
			(pad (padNum 9) (padStyleRef r100_30) (pt -1.250, 2.400) (rotation 0))
			(pad (padNum 10) (padStyleRef r100_30) (pt -0.750, 2.400) (rotation 0))
			(pad (padNum 11) (padStyleRef r100_30) (pt -0.250, 2.400) (rotation 0))
			(pad (padNum 12) (padStyleRef r100_30) (pt 0.250, 2.400) (rotation 0))
			(pad (padNum 13) (padStyleRef r100_30) (pt 0.750, 2.400) (rotation 0))
			(pad (padNum 14) (padStyleRef r100_30) (pt 1.250, 2.400) (rotation 0))
			(pad (padNum 15) (padStyleRef r100_30) (pt 1.750, 2.400) (rotation 0))
			(pad (padNum 16) (padStyleRef r100_30) (pt 2.250, 2.400) (rotation 0))
			(pad (padNum 17) (padStyleRef r100_30) (pt 2.750, 2.400) (rotation 0))
			(pad (padNum 18) (padStyleRef r100_30) (pt 3.250, 2.400) (rotation 0))
			(pad (padNum 19) (padStyleRef r100_30) (pt 3.750, 2.400) (rotation 0))
			(pad (padNum 20) (padStyleRef r100_30) (pt 4.250, 2.400) (rotation 0))
			(pad (padNum 21) (padStyleRef r100_30) (pt 4.750, 2.400) (rotation 0))
			(pad (padNum 22) (padStyleRef r100_30) (pt 5.250, 2.400) (rotation 0))
			(pad (padNum 23) (padStyleRef r165_130) (pt -7.525, 0.500) (rotation 90))
			(pad (padNum 24) (padStyleRef r165_130) (pt 7.525, 0.500) (rotation 90))
		)
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 0.000, 0.250) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -9.35 3.9) (pt 9.35 3.9) (width 0.1))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 9.35 3.9) (pt 9.35 -3.4) (width 0.1))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 9.35 -3.4) (pt -9.35 -3.4) (width 0.1))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -9.35 -3.4) (pt -9.35 3.9) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 0.25 -2.4) (pt -8.1 -2.4) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -8.1 -2.4) (pt -8.1 -1.25) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -8.1 -1.25) (pt -7.525 -1.25) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -7.525 -1.25) (pt -7.5 2.15) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -7.5 2.15) (pt 7.5 2.15) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 7.5 2.15) (pt 7.5 -1.25) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 7.5 -1.25) (pt 8.1 -1.25) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 8.1 -1.25) (pt 8.1 -2.4) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 8.1 -2.4) (pt 0.25 -2.4) (width 0.025))
		)
		(layerContents (layerNumRef 18)
			(line (pt 0 -2.4) (pt -8.1 -2.4) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt -8.1 -2.4) (pt -8.1 -1.25) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt -8.1 -1.25) (pt -7.525 -1.25) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt -7.525 -1.25) (pt -7.525 -0.85) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt 0 -2.4) (pt 8.1 -2.4) (width 0.2))
		)
		...
		(layerContents (layerNumRef 18)
			(line (pt -6 2.15) (pt -7.5 2.15) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt -7.5 2.15) (pt -7.5 1.65) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt 6 2.15) (pt 7.5 2.15) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt 7.5 2.15) (pt 7.525 1.65) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt -5.25 3.4) (pt -5.25 3.4) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(arc (pt -5.25, 3.35) (radius 0.05) (startAngle 90.0) (sweepAngle 180.0) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt -5.25 3.3) (pt -5.25 3.3) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(arc (pt -5.25, 3.35) (radius 0.05) (startAngle 270) (sweepAngle 180.0) (width 0.1))
		)
	)
	(symbolDef "54548-2272" (originalName "54548-2272")
	...
	(compDef "54548-2272" (originalName "54548-2272") (compHeader (numPins 24) (numParts 1) (refDesPrefix J)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "54548-2272"))
		(attachedPattern (patternNum 1) (patternName "545482272")
			(numPads 24)
			(padPinMap
		...
		(attr "Manufacturer_Part_Number" "54548-2272")
		(attr "Mouser Part Number" "538-54548-2272")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Molex/54548-2272?qs=vvQtp7zwQdMMCb6G6RF0NQ%3D%3D")
		(attr "Arrow Part Number" "")
		(attr "Arrow Price/Stock" "")
		(attr "Description" "FFC & FPC Connectors 0.5mmP Easy-On FFC/FPC Conn 1.20mm Hght RA SMT 22Ckt Gold")
		(attr "<Hyperlink>" "https://www.molex.com/pdm_docs/sd/545482272_sd.pdf")
		(attr "<Component Height>" "1.3")
		(attr "<STEP Filename>" "54548-2272.stp")
		(attr "<STEP Offsets>" "X=0;Y=0.55;Z=0")
