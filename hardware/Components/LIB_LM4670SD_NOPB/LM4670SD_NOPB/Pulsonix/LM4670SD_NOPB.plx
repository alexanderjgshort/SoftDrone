...
//5866/1494326/2.50/9/3/Integrated Circuit
...
(library Library_1
	...
	(padStyleDef "r210_170"
		(holeDiam 0)
		(padShape (layerNumRef 1) (padShapeType Rect)  (shapeWidth 1.7) (shapeHeight 2.1))
		(padShape (layerNumRef 16) (padShapeType Ellipse)  (shapeWidth 0) (shapeHeight 0))
	)
	(textStyleDef "Normal"
		(font
	...
	(patternDef "SON50P300X300X80-9N" (originalName "SON50P300X300X80-9N")
		(multiLayer
			...
			(pad (padNum 9) (padStyleRef r210_170) (pt 0, 0) (rotation 0))
		)
	...
	(symbolDef "LM4670SD_NOPB" (originalName "LM4670SD_NOPB")
	...
	(compDef "LM4670SD_NOPB" (originalName "LM4670SD_NOPB") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "8" (pinName "VO2") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "5" (pinName "VO1") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LM4670SD_NOPB"))
		...
		(attr "Manufacturer_Part_Number" "LM4670SD/NOPB")
		(attr "Mouser Part Number" "595-LM4670SD/NOPB")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/LM4670SD-NOPB?qs=2k4gZbgf%2F9nNpTS8Wdbmrw%3D%3D")
		(attr "Arrow Part Number" "LM4670SD/NOPB")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/lm4670sdnopb/texas-instruments?utm_currency=USD&region=nac")
		...
		(attr "<STEP Filename>" "LM4670SD_NOPB.stp")
