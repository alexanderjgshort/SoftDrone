...
(library Library_1
	...
	(symbolDef "SX1262IMLTRT" (originalName "SX1262IMLTRT")
	...
	(compDef "SX1262IMLTRT" (originalName "SX1262IMLTRT") (compHeader (numPins 25) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "VDD_IN") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "2" (pinName "GND_1") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "3" (pinName "XTA") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "4" (pinName "XTB") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "5" (pinName "GND_2") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "6" (pinName "DIO3") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "7" (pinName "VREG") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Output))
		(compPin "8" (pinName "GND_3") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "9" (pinName "DCC_SW") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Output))
		(compPin "10" (pinName "VBAT") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "11" (pinName "VBAT_IO") (partNum 1) (symPinNum 11) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "12" (pinName "DIO2") (partNum 1) (symPinNum 12) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "18" (pinName "SCK") (partNum 1) (symPinNum 13) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "17" (pinName "MOSI") (partNum 1) (symPinNum 14) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "16" (pinName "MISO") (partNum 1) (symPinNum 15) (gateEq 0) (pinEq 0) (pinType Output))
		...
		(compPin "25" (pinName "GND_5") (partNum 1) (symPinNum 19) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "24" (pinName "VR_PA") (partNum 1) (symPinNum 20) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "23" (pinName "RFO") (partNum 1) (symPinNum 21) (gateEq 0) (pinEq 0) (pinType Output))
		(compPin "22" (pinName "RFI_N") (partNum 1) (symPinNum 22) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "21" (pinName "RFI_P") (partNum 1) (symPinNum 23) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "20" (pinName "GND_4") (partNum 1) (symPinNum 24) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "19" (pinName "NSS") (partNum 1) (symPinNum 25) (gateEq 0) (pinEq 0) (pinType Input))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SX1262IMLTRT"))
		...
		(attr "Manufacturer_Part_Number" "SX1262IMLTRT")
		(attr "Mouser Part Number" "947-SX1262IMLTRT")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Semtech/SX1262IMLTRT?qs=XFmntM7Yc9eYt6yxTPughQ%3D%3D")
		(attr "Arrow Part Number" "SX1262IMLTRT")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/sx1262imltrt/semtech.html?utm_currency=USD&region=nac")
		(attr "Description" "RF Transceiver LoRa, sub-GHz RF Transceiver 22dBm PA")
		(attr "<Hyperlink>" "http://www.mouser.com/datasheet/2/761/DS_SX1261-2_V1.1-1307803.pdf")
		(attr "<Component Height>" "1")
		(attr "<STEP Filename>" "SX1262IMLTRT.stp")
