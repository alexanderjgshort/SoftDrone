...
(library Library_1
	...
	(symbolDef "FC-135R_32.7680KA-A3" (originalName "FC-135R_32.7680KA-A3")
	...
	(compDef "FC-135R_32.7680KA-A3" (originalName "FC-135R_32.7680KA-A3") (compHeader (numPins 2) (numParts 1) (refDesPrefix Y)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "FC-135R_32.7680KA-A3"))
		...
		(attr "<Hyperlink>" "https://eu.mouser.com/datasheet/2/137/FC_255_en-1649561.pdf")
		(attr "<Component Height>" "0.9")
		(attr "<STEP Filename>" "FC-135R_32.7680KA-A3.stp")
